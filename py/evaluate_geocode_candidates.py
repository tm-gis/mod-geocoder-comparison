    ...
    with open(in_csv, "rb") as csv_file:
        ...
        for r in reader:
            if r[0] != "Type":
                ...
                current = " ".join(i for i in [House_Number, Prefix, Street_Name, Street_Type]) + ", " + City + \
                          ", " + State + " " + Zip
                ...
                if not Lat and not Lon:
                    ...
                    if current not in location_dict:
                        base_url = "https://www.google.com/maps/@" + str(lat) + "," + str(lng) + "," + "16.75z"
                        location_dict[current] = [addr, lng, lat, base_url]
                    ...
                    if Type != "Intersections":
                        ...
                        try:
                            Street_Name = address_list_comma[0]
                            City = address_list_comma[1]
                            State = address_list_comma[2].split(" ")[0]
                            Zip = address_list_comma[2].split(" ")[1]
                        except:
                    ...
                    location_dict[current] = [Street_Name, Lon, Lat, "https://www.google.com/maps/@" + str(Lat) +
                                                 "," + str(Lon) + "," + "18z"]
                row = [Type, Source, Verified, Name, Prefix, House_Number, Unit_Type, Unit_Number,
                       ...
                       location_dict[current][2], location_dict[current][1], location_dict[current][3]]
                writer.writerow(row)
del csv_file
del out_file
